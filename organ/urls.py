...
urlpatterns = [
    ...
    # slug detail
    path("pledge/<int:pledge_id>-<slug:slug>/", views.pledge_detail, name="organ_pledge_detail_slug"),
    # legacy detail
    ...
    # slug detail
    path("request/<int:request_id>-<slug:slug>/", views.organ_request_detail, name="organ_request_detail_slug"),
    # legacy detail
